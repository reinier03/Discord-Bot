...
async def on_message(message):
    ...
    if message.guild and not message.author.bot:
        ...
        if "https://" in message.content.lower() and (message.channel.name.lower()=="☆promote-yourself✿" or message.channel.name.lower()=="🔞nsfw-uwu" or message.channel.name.lower()=="📢announcements" or message.channel.name.lower()=="🎨commisions-artwork-prices" or message.channel.name.lower()=="twitter-posts🐦"):
            return
